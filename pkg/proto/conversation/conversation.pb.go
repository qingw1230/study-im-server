...
type GetConversationListResp struct {
	...
	ConversationList []*public.ConversationInfo `protobuf:"bytes,2,rep,name=ConversationList,proto3" json:"ConversationList,omitempty"`
}
...
func (x *GetConversationListResp) GetConversationList() []*public.ConversationInfo {
	if x != nil {
...
var file_conversation_conversation_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x68, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61,
...
var file_conversation_conversation_proto_depIdxs = []int32{
	...
	5, // 1: pbConversation.GetConversationListResp.ConversationList:type_name -> server_api_params.ConversationInfo
